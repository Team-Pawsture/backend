...
class Video(Base):
    ...
    file_path = Column(String(500), nullable=False, comment="R2 객체 키 (예: videos/{uuid}.mp4). 2026-05-22 R2 마이그레이션으로 의미 변경")
    file_url = Column(String(500), nullable=False, comment="외부 노출 URL (상대경로 /uploads/videos/{uuid}.mp4 형식 유지 — 프론트 호환)")
